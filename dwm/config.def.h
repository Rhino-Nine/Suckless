...
static const unsigned int default_border =
    2; /* to switch back to default border after dynamic border resizing via
          keybinds */
...
static const int showsystray = 11111111111; /* 0 means no systray */
...
static const char *light_up[] = {"/usr/bin/brillo", "-u", "150000", "-A", "20"};
static const char *light_down[] = {"/usr/bin/brillo", "-u", "150000", "-U",
                                   "20"};
...
static const char *fonts[] = {
    "Iosevka Term:style:Medium:size=13",
    "Noto Sans CJK SC:style:Medium:size=13",
...
static const Rule rules[] = {
    ...
    {"Sxiv", NULL, "sxiv", 0, 0, 0, 0, 0, -1},
    {"ark", NULL, NULL, 0, 1, 1, 0, 0, -1},
    {"Motrix", NULL, NULL, 0, 1, 1, 0, 0, -1},
};
...
static const Key keys[] = {
    ...
    {MODKEY, XK_c, spawn, SHCMD("rofi-launcher")},
    {MODKEY, XK_Escape, spawn, SHCMD("rofi-powermenu")},
    {MODKEY, XK_Return, spawn, SHCMD("st &")},

    // open bookmarks
    {MODKEY | ShiftMask, XK_equal, spawn, SHCMD("rofi-bookmark_add")},
    // { MODKEY,                        XK_equal,   spawn,          SHCMD(
    // "xdotool type $(grep -v '^#' ~/.local/share/bookmarks | rofi -dmenu -i -l
    // 25 -theme $HOME/.config/rofi/launchers/type-4/style-2.rasi | cut -d' '
    // -f1)") },
    {MODKEY, XK_equal, spawn, SHCMD("rofi-bookmark_load")},
    ...
    {MODKEY, XK_s, spawn, SHCMD("flameshot gui -d 1000 &")},
